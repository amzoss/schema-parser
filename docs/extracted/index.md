...
| noticeConfig/recurringPeriod            | object          |                                                                                                                                                                                                                                                          |
...
| type                              | string          | The class of user like staff or patron; this is different from patronGroup; it can store shadow and system user types also                                                                                                                               |
