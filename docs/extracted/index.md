...
| loan/forUseAtLocation                                    | object          | Status of loan/item that is to be used in the library, i.e. in a reading room                                                                                                                                                                            |
| loan/forUseAtLocation/status                             | string          | Indicates if the item is currently used by or being held for the patron                                                                                                                                                                                  |
| loan/forUseAtLocation/statusDate                         | string          | Date and time the status was registered                                                                                                                                                                                                                  |
| loan/forUseAtLocation/holdShelfExpirationDate            | string          | Date when a held item expires                                                                                                                                                                                                                            |
...
| locations                  | array           | Locations associated with this fund                                                                                                                                    |
| locations/locationId       | string          | The UUID format string                                                                                                                                                 |
| locations/tenantId         | string          | Tenant id of the associated location                                                                                                                                   |
| tags                       | object          | List of simple tags that can be added to an object                                                                                                                     |
| tags/tagList               | array           | List of tags                                                                                                                                                           |
| metadata                   | object          | Metadata about creation and changes to records, provided by the server (client should not provide)                                                                     |
| metadata/createdDate       | string          | Date and time when the record was created                                                                                                                              |
...
| additionalCallNumbers            | array           | Additional Call Numbers to track the history of identifiers assigned to an item.                                                                                                                                                                         |
...
| sourceUri                                | string          | A remote URI uniquely identifying the source of the instance                                                                                                                                                                                                                                                                                         |
...
| privilegedContacts           | array              | An array of privileged contact record IDs                                                                                                                                                                                                               |
...
| personal/profilePictureLink       | string          | Link to the profile picture, or only the id of the /users/profile-picture entry                                                                                                                                                                          |
